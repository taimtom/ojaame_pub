...
export function InvoiceHistoryTableToolbar({ filters, options }) {
  ...
  return (
    <>
      {/* <FormControl sx={{ flexShrink: 0, width: { xs: 1, md: 200 } }}>
        <InputLabel htmlFor="category-filter-stock-select-label">Stock</InputLabel>
        ...
        <Select
          ...
          inputProps={{ id: 'category-filter-stock-select-label' }}
      ...
      <FormControl sx={{ flexShrink: 0, width: { xs: 1, md: 200 } }}>
        <InputLabel htmlFor="category-filter-publish-select-label">Publish</InputLabel>
        <Select
          multiple
          ...
          renderValue={(selected) => selected.map((value) => value).join(', ')}
          inputProps={{ id: 'category-filter-publish-select-label' }}
          sx={{ textTransform: 'capitalize' }}
        >
