...
import { useCompanyYearlySales } from 'src/actions/dashboard';

import { Chart, useChart, ChartSelect, ChartLegends } from 'src/components/chart';

export function AnalyticsYearlySales({ title, subheader, companyId, ...other }) {
 ...
 const yearOptions = useMemo(
   ...
   const { data, loading } = useCompanyYearlySales(companyId, year);
