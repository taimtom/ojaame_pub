...
const Jwt = {
  ...
  UserNewPage: lazy(() => import('src/pages/auth/jwt/staff-update')),
  CompanyNewPage: lazy(() => import('src/pages/auth/jwt/company-update')),
  GoogleAuthCallback: lazy(() => import('src/pages/auth/GoogleCallbackPage')),
};
...
const authJwt = {
  ...
  children: [
    ...
    {
      path: 'update-staff/:invitation_id',
      element: (
        <AuthCenteredLayout>
          <Jwt.UserNewPage />
        </AuthCenteredLayout>
  ...
  children: [
    ...
    },
    {
      ...
      element: (
        <GuestGuard>
          <AuthSplitLayout>
            <Jwt.GoogleAuthCallback /> {/* This loads GoogleCallbackPage */}
          </AuthSplitLayout>
        </GuestGuard>
      ),
    }
...
export const authRoutes = [
  {
    ...
    },authAmplify, authFirebase, authAuth0, authSupabase],
  },
];
