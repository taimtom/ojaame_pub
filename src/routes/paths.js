...
export const paths = {
  ...
  dashboard: {
    ...
    reports: {
      ...
      taxEstimates: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/tax-estimates`,
      vatReturn: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/vat-return`,
      taxAnnual: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/tax-annual`,
      loans: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/loans`,
      payroll: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/payroll`,
      wht: (storeParam) => `${ROOTS.DASHBOARD}/${storeParam}/reports/wht`,
